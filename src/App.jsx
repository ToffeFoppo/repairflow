...
const SHOP_NAME  = "Foppo RepairSystem";
const SHOP_BRAND = "Foppo";
const SHOP_ADDR  = "Korjauskatu 7, 33100 Tampere";
const SHOP_TEL   = "+358 40 000 0000";
const SHOP_EMAIL = "info@repairflow.fi";
const SHOP_BIZ   = "Y-tunnus: 1234567-8";
...
const INITIAL_CUSTOMERS = [
  { id:"c1", name:"Marcus Webb",     email:"marcus@example.com", phone:"+358 40 123 4567", sms_opt_in:true  },
  { id:"c2", name:"Sara Okonkwo",    email:"sara@example.com",   phone:"+358 44 234 5678", sms_opt_in:true  },
  { id:"c3", name:"Diego Reyes",     email:"diego@example.com",  phone:"+358 50 345 6789", sms_opt_in:false },
  { id:"c4", name:"Priya Nair",      email:"priya@example.com",  phone:"+358 45 456 7890", sms_opt_in:true  },
  { id:"c5", name:"Thomas Brandt",   email:"thomas@example.com", phone:"+358 40 567 8901", sms_opt_in:true  },
  { id:"c6", name:"Anni Mäkinen",    email:"anni.m@example.fi",  phone:"+358 50 678 9012", sms_opt_in:true  },
  { id:"c7", name:"Juhani Virtanen", email:"juhani@example.fi",  phone:"+358 44 789 0123", sms_opt_in:false },
  { id:"c8", name:"Leena Korhonen",  email:"leena.k@example.fi", phone:"+358 40 890 1234", sms_opt_in:true  },
];
const SEED_TECHNICIANS = [
  { id:"tech1", name:"Mikael Lund",    initials:"ML", color:"#D4175A" },
  { id:"tech2", name:"Sara Virtanen",  initials:"SV", color:"#1A5FAB" },
  { id:"tech3", name:"Jonas Eriksson", initials:"JE", color:"#1F8A55" },
];

// ─── PARTS CATALOGUE ──────────────────────────────────────────────────────────
// Schema: { id, name, sku, supplier, cost (excl.VAT), stock_qty, min_stock,
//           compatible_models: [modelId], compatible_categories: ["Phone"|...] }
// compatible_categories = [] means show for specific models only
// compatible_models = [] + compatible_categories set = show for ALL of that category

const SEED_CATALOGUE = [
  // iPhones
  { id:"cat1",  part_category:"Screens",  name:"iPhone 15 OLED Screen Assembly",     sku:"APL-IP15-SCR",    supplier:"iFixit",    cost:62.00,  avg_cost:62.00,  stock_qty:2,  min_stock:1, compatible_models:["seed_25","seed_26"], compatible_categories:[] },
  { id:"cat2",  part_category:"Batteries",  name:"iPhone 15 Battery 3277mAh",          sku:"APL-IP15-BAT",    supplier:"iFixit",    cost:18.50,  avg_cost:18.50,  stock_qty:4,  min_stock:2, compatible_models:["seed_25","seed_26","seed_27","seed_28"], compatible_categories:[] },
  { id:"cat3",  part_category:"Screens",  name:"iPhone 14 Pro OLED Screen Assembly",  sku:"APL-14P-SCR",    supplier:"iFixit",    cost:52.00,  avg_cost:52.00,  stock_qty:1,  min_stock:2, compatible_models:["seed_22","seed_23"], compatible_categories:[] },
  { id:"cat4",  part_category:"Batteries",  name:"iPhone 14 Battery 3279mAh",          sku:"APL-IP14-BAT",    supplier:"iFixit",    cost:17.00,  avg_cost:17.00,  stock_qty:0,  min_stock:2, compatible_models:["seed_22","seed_23","seed_24"], compatible_categories:[] },
  { id:"cat5",  part_category:"Ports & Connectors",  name:"iPhone Charging Port Assembly",       sku:"APL-CHGPORT-U",   supplier:"iFixit",    cost:9.50,  avg_cost:9.50,   stock_qty:6,  min_stock:3, compatible_models:[], compatible_categories:["Phone"] },
  // Samsung
  { id:"cat6",  part_category:"Screens",  name:"Galaxy S23 Ultra AMOLED Screen",     sku:"SAM-S23U-SCR",    supplier:"Screens4U", cost:78.00,  avg_cost:78.00,  stock_qty:1,  min_stock:1, compatible_models:["seed_47"], compatible_categories:[] },
  { id:"cat7",  part_category:"Batteries",  name:"Galaxy S23 Series Battery",          sku:"SAM-S23-BAT",     supplier:"Screens4U", cost:14.00,  avg_cost:14.00,  stock_qty:3,  min_stock:2, compatible_models:["seed_47","seed_48","seed_49"], compatible_categories:[] },
  // iPad
  { id:"cat8",  part_category:"Batteries",  name:"iPad Mini 6 Battery 5124mAh",        sku:"APL-IM6-BAT",     supplier:"iFixit",    cost:21.00,  avg_cost:21.00,  stock_qty:0,  min_stock:1, compatible_models:["seed_66"], compatible_categories:[] },
  // MacBook
  { id:"cat9",  part_category:"Keyboards & Cases",  name:"MacBook Pro 14 Top Case + Keyboard", sku:"APL-MBP14-TC",    supplier:"MacParts",  cost:135.00,  avg_cost:135.00, stock_qty:0,  min_stock:1, compatible_models:["seed_80","seed_81"], compatible_categories:[] },
  // Universal
  { id:"cat10", part_category:"Adhesives & Kits", name:"Adhesive Seal Kit (Universal)",      sku:"APL-SEAL-U",      supplier:"iFixit",    cost:4.50,  avg_cost:4.50,   stock_qty:12, min_stock:5, compatible_models:[], compatible_categories:["Phone","Tablet"] },
  { id:"cat11", part_category:"Tools & Hardware", name:"Tri-Point / Pentalobe Screw Set",    sku:"TOOL-SCREW-U",    supplier:"iFixit",    cost:2.80,  avg_cost:2.80,   stock_qty:8,  min_stock:4, compatible_models:[], compatible_categories:[] },
  { id:"cat12", part_category:"Cameras", name:"OnePlus 12 Front Camera Module",     sku:"OPL-12-CAM",      supplier:"Screens4U", cost:25.00,  avg_cost:25.00,  stock_qty:0,  min_stock:1, compatible_models:["seed_85"], compatible_categories:[] },
];

const INITIAL_TICKETS = [
  { id:"TKT-0041", technician_id:"tech1", customer_id:"c1", device_category:"Phone",    device_manufacturer:"Apple",   device_model:"iPhone 14 Pro",         serial_imei:"352940123456789",  access_code:"4729",         warranty_months:12, issue_desc:"Cracked screen, no touch response in lower third",  initial_quote:149, status:"diagnosis",           technician_notes:"Back glass also slightly cracked near camera.", created_at:"2026-03-01T08:22:00Z" },
  { id:"TKT-0042", technician_id:"tech2", customer_id:"c2", device_category:"Tablet",   device_manufacturer:"Apple",   device_model:"iPad Mini 6",           serial_imei:"F4GTQ2XYZABC",     access_code:"",             warranty_months:12, issue_desc:"Battery drains to 0% within 2 hours of light use",  initial_quote:99,  status:"part_ordered",        technician_notes:"", created_at:"2026-03-01T09:45:00Z" },
  { id:"TKT-0043", customer_id:"c3", device_category:"Phone",    device_manufacturer:"Samsung", device_model:"Galaxy S23 Ultra",      serial_imei:"354123987654321",  access_code:"kuvio: ↘↗↙↖", warranty_months:6,  issue_desc:"Charging port loose, intermittent connection",      initial_quote:75,  status:"intake",              technician_notes:"", created_at:"2026-03-02T07:10:00Z" },
  { id:"TKT-0044", technician_id:"tech1", customer_id:"c4", device_category:"Computer", device_manufacturer:"Apple",   device_model:"MacBook Pro 14\" M2 Pro",serial_imei:"C02XG2XYZDEF",    access_code:"",             warranty_months:12, issue_desc:"Keyboard keys unresponsive — A, S, D, F",           initial_quote:250, status:"part_arrived",        technician_notes:"Likely butterfly mechanism debris.", created_at:"2026-03-01T14:30:00Z" },
  { id:"TKT-0045", technician_id:"tech3", customer_id:"c5", device_category:"Phone",    device_manufacturer:"OnePlus", device_model:"OnePlus 12",            serial_imei:"354899001122334",  access_code:"1234",         warranty_months:12, issue_desc:"Front camera completely black after drop",          initial_quote:110, status:"repair_in_progress",  technician_notes:"Camera flex cable damaged.", created_at:"2026-02-28T11:00:00Z" },
  { id:"TKT-0046", customer_id:"c1", device_category:"Computer", device_manufacturer:"Dell",    device_model:"XPS 15 9530",           serial_imei:"CN0ABCD1234567",   access_code:"",             warranty_months:24, issue_desc:"Overheating, thermal throttling under load",        initial_quote:85,  status:"ready_for_pickup",    technician_notes:"Repasted with Thermal Grizzly. Fan cleaned.", created_at:"2026-02-27T16:00:00Z" },
];
const INITIAL_PARTS = [
  { id:"p1", ticket_id:"TKT-0041", part_name:"iPhone 14 Pro OLED Screen Assembly", supplier_sku:"APL-14P-SCR",  qty:1, cost:52.00,  part_status:"pending", is_accessory:false },
  { id:"p2", ticket_id:"TKT-0041", part_name:"Adhesive Seal Kit",                   supplier_sku:"APL-SEAL-U",   qty:1, cost:4.50,   part_status:"pending", is_accessory:false },
  { id:"p3", ticket_id:"TKT-0042", part_name:"iPad Mini 6 Battery 5124mAh",         supplier_sku:"APL-IM6-BAT",  qty:1, cost:21.00,  part_status:"ordered", is_accessory:false },
  { id:"p4", ticket_id:"TKT-0044", part_name:"MacBook Pro 14 Top Case + Keyboard",  supplier_sku:"APL-MBP14-TC", qty:1, cost:135.00, part_status:"arrived", is_accessory:false },
  { id:"p5", ticket_id:"TKT-0045", part_name:"OnePlus 12 Front Camera Module",       supplier_sku:"OPL-12-CAM",   qty:1, cost:25.00,  part_status:"arrived", is_accessory:false },
  { id:"p6", ticket_id:"TKT-0042", part_name:"Custom Leather Case – Midnight",       supplier_sku:"ACC-CASE-ML",  qty:1, cost:18.00,  part_status:"pending", is_accessory:true  },
];
const INITIAL_LOGS = [
  { id:"l1", ticket_id:"TKT-0044", customer_id:"c4", channel:"email", template_key:"part_arrived", sent_at:"2026-03-02T09:14:00Z", status:"sent" },
  { id:"l2", ticket_id:"TKT-0045", customer_id:"c5", channel:"sms",   template_key:"part_arrived", sent_at:"2026-03-01T15:30:00Z", status:"sent" },
];
...
// ─── PARTS ORDER ──────────────────────────────────────────────────────────────
function PartsOrderView({ tickets, setTickets, customers, parts, updatePartStatus, manualOrders, setManualOrders, toast, catalogue, setCatalogue }) {
  const [showForm, setShowForm] = useState(false);
  ...
  function updateAccItemStatus(ticketId, itemId, status) {
    setTickets(ts => ts.map(t => {
      if (t.id !== ticketId) return t;
      const updated = (t.acc_items || []).map(i => i.id === itemId ? { ...i, status } : i);
      return { ...t, acc_items: updated };
    }));
  }
